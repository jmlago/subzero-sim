...
You are a member of Team A. You score 1 point per turn.
...
1. Add 1 point for your team:
   ```bash
   swarm-msg send scoreboard '{"action": "add_points", "team": "A", "points": 1}'
   ```
...
```bash
swarm-msg send scoreboard '{"action": "add_points", "team": "A", "points": 1}'
swarm-msg send metrics '{"action": "state_report", "data": {"state": {"points_contributed": 1}}}'
swarm-msg send tick '{"action": "turn_complete"}'
```
